  ...
  useEffect(() => {
    ...
    async function fetchAthleteByUsername() {
      ...
      try {
        ...
        // 1. Récupérer le user_id de l'athlète via son username
        ...
        // 2. Charger les données filtrées par l'ID de l'utilisateur
        ...
        <SectionWrapper delay={0.1}>
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="flex flex-col gap-1">
              <h1 className="text-3xl font-extrabold tracking-tight text-white drop-shadow-sm select-none uppercase">
