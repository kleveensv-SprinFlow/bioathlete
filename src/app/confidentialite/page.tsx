      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 py-12 flex flex-col gap-8">
        ...
        >
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-base font-bold text-emerald-400">1. Collecte des données</h2>
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-base font-bold text-emerald-400">2. Gestion par Supabase</h2>
            <p className="text-xs text-gray-300 leading-relaxed">
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-base font-bold text-emerald-400">3. Absence de revente</h2>
            <p className="text-xs text-gray-300 leading-relaxed">
          ...
          <section className="flex flex-col gap-2">
            <h2 className="text-base font-bold text-emerald-400">4. Vos droits</h2>
            <p className="text-xs text-gray-300 leading-relaxed">
